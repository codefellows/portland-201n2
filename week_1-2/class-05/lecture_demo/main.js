var names = new Array("John", "Mary", "Jane", "Stephen", "Mark");

function listNames() {
  for (var index = 0; index < names.length; index++) {
    console.log("Name (index="+index+"): "+names[index]);
  }
}

function addNamesToTable() {
  var currentTableInfo = document.getElementById("studentTable").innerHTML;
  for (var index = 0; index < names.length; index++) {
    currentTableInfo += "<tr><td>"+names[index]+"</td><td>- N/A -</td><td>- N/A -</td></tr>";
  }
  document.getElementById("studentTable").innerHTML = currentTableInfo;
}
